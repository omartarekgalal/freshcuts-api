/* ═══════════════════════════════════════════════════════════════════════════
   ...
   التوزيع **مضبوط بالظبط** (مفيش فروقة ولا هللة):
     ١. T = round(سعر الباقة شامل الضريبة × MULTIPLY ÷ (1 + ضريبة))
        = إجمالي الباقة **قبل** الضريبة بوحدة النظام الصحيحة (ميكرو-ريال).
     ...
     ٤. الباقي R = T − Σ(نصيب × كمية) بيتوزّع **وحدة وحدة** بطريقة «أكبر كسر
        متبقي» (largest remainder / Hamilton) — كل وحدة بتاخد +١ ميكرو.
   ...
   83.478260869565… قبل الضريبة، وده كسر دوري. بنشتغل على دقة الميكرو (1e6)
   — نفس دقة أسعار تاب سينس نفسها تقريباً (مثال: «طرب كيلو» = 121.73913043
   قبل الضريبة = 140.00 شامل) — فالفرق بيطلع أقل من واحد على المليون من
   الريال، وبيختفي تماماً عند أي تقريب لهللتين. (كنا على النانو 1e9 لحد ١٧
   سبتمبر ٢٠٢٦، لكن تاب سينس بترفض أي unit_amount ≥ 1e11 فكل كيلو فوق ١٠٠
   ر.س كان بيترفض — شوف money.js.)

   الملف ده **صافي** (مفيش داتابيز ولا شبكة) عشان كل قاعدة فيه تتجرّب أوفلاين
   — الفلوس هنا فلوس عملاء حقيقيين.
═══════════════════════════════════════════════════════════════════════════ */

// نفس وحدة tsstore بالظبط — ميكرو ريال (money.js). لازم تفضل مشتركة: سطور
// الباقة بتتجمع مع حساب تاب سينس في نفس الإجمالي، وبتتخزّن في نفس العمود.
export { MULTIPLY } from "./money.js";
