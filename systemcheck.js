...
const SEED_TASKS = [
  ...
  },
  {
    ...
    why: "تقييمنا العالي على جوجل (الرقم الحي في التقييمات ← جوجل) بيوصّل الناس لبروفايل مفيهوش رابط طلب. دي أرخص زيادة مبيعات موجودة — "
  ...
  },
  {
    ...
    note: "تاريخ العرض بيتغيّر من مكان واحد من غير نشر: لوحة المتجر ← المنتجات ← العروض والباقات (#store/products/offers)",
  },
  {
