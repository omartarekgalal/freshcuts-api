...
export const OWNER_PLAYBOOK = {
  ...
  store: [
    ...
    "رسايل SMS تسويقية شغّالة (مُرسل FreshCut-AD): ساعات هدوء ١٠م–١٢ظ، فاصل متدرّج (٣ أيام لزبون طلب آخر ٣٠ يوم، ٧ للغايب، ١٤ للبارد) + سقف ٢ رسالة/أسبوع و٤/شهر، holdout ١٥٪، فرامل عند إلغاء اشتراك >٥٪. سطر الإيقاف كلمة مش رابط (أرسل اسم المرسل لـ801001).",
    "الصالة والتطبيقات (كيتا/هنقرستيشن/نينجا/جاهز) لسه شغّالين كقنوات بيع، بس عروض ٩٦ مش متاحة عليها. **قرار عمر ٢١/٩: مفيش صرف ولا محتوى ولا رسايل بتوجّه على التطبيقات خالص — كل حاجة على freshcuts.sa.** أي اقتراح بميزانية أو كابشن فيه اسم تطبيق = مرفوض.",
  ],
  ads: [
